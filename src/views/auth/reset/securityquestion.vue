<template>
  <div class="h-5/6 2xl:h-3/6 w-2/3 block rounded-lg bg-white -mt-12">
    <div
      class="w-80 lg:w-full xl:w-full md:w-full h-full block p-4 relative right-32 lg:right-0 xl:right-0 md:right-0 border-2 border-gray-300 rounded-lg"
    >
      <form class="m-8" @submit.prevent="submit">
        ...
        <div class="mb-5">
          <cornie-input v-model="email" required class="w-full" label="Email" />
        </div>
        <div class="mb-8">
          <cornie-input
            v-model="email"
        ...
        <div class="mb-8">
          <label
            class="block uppercase tracking-wide text-dark-700 text-xs font-bold mb-2"
            for="grid-state"
          >
            2FA CODE
          </label>
