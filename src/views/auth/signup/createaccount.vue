    ...
    >
      <v-form class="w-full p-6" @submit="submit">
        ...
        <div class="grid grid-cols-4 gap-4 col-span-full">
          <p
            class="text-xs text-gray-500 mb-2 font-bold"
            :class="{ 'text-gray-900': width == 25 }"
          >
            Account Type
          </p>
          <p
            class="text-xs text-gray-500 mb-2 font-bold"
            :class="{ 'text-gray-900': width == 50 }"
          >
            Personal Info
          </p>
          <p
            class="text-xs text-gray-500 mb-2 font-bold"
            :class="{ 'text-gray-900': width == 75 }"
          >
            Email Verification
          </p>
          <p
            class="text-xs text-gray-500 mb-2 font-bold"
            :class="{ 'text-gray-900': width == 100 }"
          >
            Password
          </p>
        </div> -->
          ...
          <div class="grid grid-cols-3 gap-4 mb-32">
            ...
            <div class="cursor-pointer">
              ...
              >
                ...
                >
                  <li
                    class="list-none items-center flex text-sm font-semibold text-gray-700 hover:bg-gray-100 hover:text-gray-900 cursor-pointer my-1 -m-2 p-5 py-2"
                  >
                    <span class="flex item-center">
                      <cornie-radio
                        name="provider"
