    ...
    <cornie-card height="100%" class="flex flex-col">
      ...
      <cornie-card-text class="flex-grow scrollable">
        <v-form class="container" ref="form">
            ...
            <div class="mb-5">
                <p class="text-gray-400 text-sm text-center hidden">This bill has been settled in full.</p>
                <p class="text-gray-400 text-sm hidden">This bill has been partially paid for. To settle the balance, select an option below.</p>
                 <p class="text-gray-400 text-sm">To settle this bill, select an option below.</p>
            </div>
            <div class="flex w-full justify-between">
                <div class="flex space-x-2 items-center">
                    <bill-icon class="fill-current text-green-500"/>
                    <span class="text-sm text-green-500">Pay Bill</span>
                </div>
                <div class="flex space-x-2 items-center">
                    <checkout-icon/>
                    <span class="text-sm text-danger">Share Bill</span>
                </div>
            </div>
        </v-form>
      </cornie-card-text>
