        ...
        <div title="Shift Breaks" class="bg-white shadow-xl">
            <div class="w-full px-4 breaks-area" :class="{ 'breaks-area-full': showBreaks }">
                    ...
                    <h2 class="flex w-full justify-between">
                        ...
                        <span @click="toggleBreaksDisplay" class="cursor-pointer mt-2"><ChevronDown /></span>
                    </h2>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="w-full mt-3">
                        ...
                        <div class="w-full flex-wrap flex mt-1">
                            <div class="mr-6" v-for="(type, index) in breakTypes" :key="index" style="width">
                                <label class="inline-flex items-center">
                                    <input type="radio" class="form-radio h-4 w-4" @change="selectBreakType(type.code)" v-model="type.code" name="break" >
                ...
                <div class="container-fluid pb-3 pt-3">
                    <div class="w-12/12">
                        <CornieInput v-model="data.location" label="Description"  placeholder="--Enter--" style="width: 100%" />
                    </div>
                    <div class="w-full flex items-center justify-between">
                        <div class="w-6/12">
                            <label for="" class="w-95">
                                ...
                                <div class="w-10/12">
                                    <input type="time" v-model="shift.timeFrom" class="w-full border rounded-lg p-2 " id="appt" required>
                                </div>
                            </label>
                        </div>
                        <div class="w-6/12">
                ...
                <div class="container-fluid pb-3 pt-3">
                    <div class="w-12/12">
                        <CornieInput v-model="data.location" label="duration (MINUTES)"  placeholder="" :disable="true"  style="width: 100%"  />
                    </div>
                </div>
            </div>
        </div>
