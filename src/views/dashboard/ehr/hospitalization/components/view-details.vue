<template>
  <div class="container-fluid">
    <div class="w-full p-2">
      <div
        class="w-full flex items-start pb-4"
            ...
            <div class="w-full flex items-center">
              <div class="w-6/12">
                ...
                <p class="flex flex-col my-4">
                  ...
                  <span class="">{{
                    new Date(hospitalisation.createdAt).toLocaleDateString()
                  }}</span>
                </p>
                <p class="flex flex-col my-4">
        ...
        <div class="w-full flex items-start">
          <div class="w-3/12">
            <p class="flex flex-col my-2">
              ...
              <span class="subheader my-2"
                >12, Idowu Martin Street, Victoria Island, Lagos</span
              >
            </p>
          </div>
          <div class="w-3/12">
      ...
      <div class="w-full flex justify-end mt-4">
        <CornieBtn
          @click="$emit('onedit', hospitalisationId)"
          class="p-2 rounded-full px-8 mx-2 cursor-pointer border"
        >
...
export default class DetailsView extends Vue {
  ...
  get patient() {
    ...
    const target = this.patients.find(
      (patient) => patient.id === this.$route.params.id
    );
    return target;
  }
