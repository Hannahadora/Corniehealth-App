            ...
            <overlay :show="showModal">
                ...
                <div class="w-full p-2" style="min-width: 450px">
                            ...
                            <div class="w-full flex flex-wrap py-2">
                                <div class="mx-3">
                                    <label class="inline-flex items-center"  @click="selectItem('location')">
                                        <input v-model="referenceType" type="radio" class="form-radio h-4 w-4" :value="'location'" >
                                        <span class="ml-2 text-sm">Location</span>
                                    </label>
                                </div>
                                <div class="mx-3">
                                    <label class="inline-flex items-center">
                                        <input v-model="referenceType" type="radio" class="form-radio h-4 w-4" :value="'organisation'" >
                    ...
                    <div class="w-full" v-if="items?.length > 0">
                        <div :class="{ 'item': location?.id === localValue?.id }" class="w-full flex items-center my-2 cursor-pointer p-2" @click="selectItem(location)" 
...
export default class LocOrg extends Vue {
    ...
    get items() {
        ...
        if (this.query) return list.filter(item => {
