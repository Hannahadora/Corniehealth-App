          ...
          <div class="w-6/12">
            <div class="w-11/12">
              <date-time-picker :label="'Performed date & Time'" :width="'w-full'">
                <template #date>
                  <span>{{
                    new Date(procedure.performedDate ?? Date.now()).toLocaleDateString()
                  }}</span>
                </template>
                <template #time>
                  <span>{{ "00:00" }}</span>
                ...
                <template #input>
                  ...
                  ></v-date-picker>
                  <label class="block uppercase my-1 text-xs font-bold"> Time </label>
      ...
      <template #form>
        <div class="w-full flex items-center mb-3">
          <div class="w-6/12">
            <cornie-select
              :label="'Function'"
              :items="['Specialized surgeon', 'Radiation therapist', 'Chiropractor']"
            />
          </div>
          <div class="w-6/12">
            <cornie-select
        ...
        <div class="w-full flex items-center mb-3">
          ...
          <div class="w-6/12">
            <cornie-select
              ...
              :items="['Change of dressing', 'Removal of suture', 'Removal of drain']"
            />
          </div>
        </div>
        <div class="w-full flex items-center mb-3">
