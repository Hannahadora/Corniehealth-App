    ...
    <v-form ref="form">
      ...
      >
        <div class="w-full mt-5 pb-5">
          ...
          <div class="grid grid-cols-2 gap-4">
            <cornie-input
              label="onset range (1st value)"
              class="w-full mb-4"
              v-model="onSet.onsetRange[' ']"
              placeholder="Enter"
            />
            <cornie-input
              label="onset range (2nd value)"
              class="w-full mb-4"
              v-model="onSet.onsetRange[' ']"
              placeholder="Enter"
            />
          ...
          <div class="grid grid-cols-2 gap-4">
            <cornie-input
              label="onset string"
              class="mb-5 w-full"
              v-model="onSet.onsetString"
            />
            <div class="mb-5">
              <label
                for="ecounter"
                class="flex uppercase text-black text-xs font-bold"
                >recorded date
                <span class="ml-2">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="mb-3">
              <label
                for="ecounter"
                class="flex uppercase mb-1 text-xs text-black font-bold"
                >asserter
                <span class="ml-2">
                  <info-icon class="text-primary fill-current"
                /></span>
