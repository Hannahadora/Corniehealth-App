              ...
              <div class="border-b-2 pb-3 border-dashed">
                ...
                <div class="w-full flex space-x-4 justify-center">
                  <div class="grid grid-cols-3 gap-4 w-full">
                    ...
                    />
                    <cornie-radio
                      label="Imunization Recommendation"
                      class="text-xs"
                      name="reference"
              ...
              <div class="w-full mt-4">
                <div class="">
                  ...
                  <div class="overflow-y-auto h-96">
                    <div>
                        <div v-if="refType == 'careplan'">
                          <div v-for="(input, index) in patientCarePlans" :key="index">
                          <div
                          ...
                          >
                              ...
                              <div class="w-full">
                                  ...
                                  <p class="text-xs text-gray-300">{{new Date(input.startDate).toLocaleDateString()}}</p>
                              </div>
                              </div>
                          </div>
                          </div>
