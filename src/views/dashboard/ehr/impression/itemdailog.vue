            ...
            <div class="flex flex-col p-3 mb-7 h-96">
                <div class="border-b-2 pb-3 border-dashed">
                    <cornie-select
                        ...
                        class="w-full"
                        :items="['Observation','Questionaire Response','Family member History','Diagnostic Report','Risk Assessment']"
                        v-model="type"
                        >
                        </cornie-select>
                </div>
                <div class="w-full">
                    <div class="mt-4 mb-4">
                        <p class="text-gray-400 text-xs">{{check3.practitioners.length}} selected</p>
                    </div>
                    ...
                    <div  v-if="observeFilter">
                        ...
                        <div class=" w-full mt-5 p-3">
                            <div class="w-full">
                             ...
                             <div class="w-full -mt-8 cursor-pointer w-full text-xs text-danger">
                                    <input
                                        type="checkbox"
                                       v-model="check3.practitioners" :value="'Identifier'"
