<template>
  ...
  <div class="w-full flex flex-col justify-center items-center h-96">
    ...
    <h3 class="text-center">
      Schedule a new visit by clicking the button below
    </h3>
    <button
      class="bg-danger rounded-full text-white mt-5 py-2 px-8 focus:outline-none hover:opacity-90 font-semibold"
      @click="() => $emit('clicked')"
    >
      Go to Appointments
    </button>
