    ...
    <div class="w-full">
      <div class="container px-2 content-con">
          ...
          <div class="w-full mb-6">
            <input-desc-rounded :label="'Current Status'" :info="''">
              <input
                disabled
                type="text"
                v-model="updateData.currentStatus"
                class="p-2 border w-100 w-full"
                style="border-radius: 8px; color: #667499"
              />
            </input-desc-rounded>
          </div>
          ...
          <div class="w-full my-6">
            <input-desc-rounded :label="'Last Date Updated'" :info="''">
              <input
                disabled
                type="text"
                v-model="updateData.lastUpdated"
                class="p-2 border w-100 w-full"
                style="border-radius: 8px; color: #667499"
              />
            </input-desc-rounded>
        ...
        <div class="w-full flex flex justify-end mt-12">
          <corniebtn
            class="text-primary p-2 cancel-btn rounded-full px-8 mx-2 cursor-pointer"
          >
