<template>
  <cornie-dialog v-model="show" right class="w-1/2 h-full">
        ...
        <v-form class="flex-grow flex flex-col">
          ...
          <accordion-component class="rounded-none border-none text-primary" title="Location" :opened="false">
            <div class="grid grid-cols-2 gap-6 py-6">
              ...
              <date-time-picker v-model:date="location.startDate" v-model:time="location.startTime" class="w-full"
                label="Start Date/Time" />
              <date-time-picker v-model:date="location.endDate" v-model:time="location.endTime" class="w-full"
                label="End Date/Time" />
    ...
    <div>
      <reason-reference @selectedId="setReasonReference" :conditions="conditions" v-model="showReference" />
      <conditionM @selectedId="setDiagnosisCondition" :conditions="conditions" v-model="showCondition" />
      <person-reference @selectedId="setPersonReference" v-model="showPersonReference" />
