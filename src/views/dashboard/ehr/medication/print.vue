                ...
                <div  class="w-full h-full">
                    <div class="w-full">
                            <div class="bg-primary p-5 w-full flex mb-5">
                                <p class="float-left text-white w-full">Prescription ID #: <span class="font-semibold">{{ input.identifier }} </span></p>
                                    <p class="float-right flex justify-end w-full text-white">Status: <span class="font-semibold">{{ input.status }}</span></p>
                            </div>
                            <div class="">
