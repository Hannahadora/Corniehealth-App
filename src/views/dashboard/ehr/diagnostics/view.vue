        ...
        <div class="mt-10 float-left">
          ...
          <div class="mt-5">
            ...
            <p class="text-xs mb-2">
              {{ PatientName.contactInfo[0].primaryAddress }}
            </p>
            <p class="text-xs mb-2">
              {{
      ...
      <div class="w-full">
        ...
        <div class="w-full grid grid-cols-4 gap-8 mt-4">
          ...
          <div>
            ...
            >
            <p class="text-xs">
              {{ otherrequestModel.request.occurenceTiming }}
            </p>
          </div>
          <!-- <div>
