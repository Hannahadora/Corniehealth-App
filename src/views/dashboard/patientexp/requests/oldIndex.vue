            ...
            >
              <span class="flex justify-end w-full mb-8">
                <button
                  ...
                  @click="
                    $router.push('/dashboard/provider/experience/add-request')
                  "
                >
                  New Request
                </button>
            ...
            >
              <span class="flex justify-end w-full mb-8">
                <button
                  ...
                  @click="
                    $router.push(
                      '/dashboard/provider/experience/add-other-requests'
                    )
                  "
                >
                  New Request
              ...
              <cornie-table :columns="rawHeadersothers" v-model="itemsothers">
                <template #actions="{ item }">
                  <div
                    ...
                    @click="
                      $router.push(
                        `/dashboard/experience/view-other-request/${item.id}`
                      )
                    "
                  >
                  ...
                  <div
                    ...
                    @click="
                      $router.push(
                        `/dashboard/experience/edit-other-request/${item.id}`
                      )
                    "
                  >
                    <newview-icon class="text-yellow-500 fill-current" />
