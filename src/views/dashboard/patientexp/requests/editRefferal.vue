      ...
      >
        ...
        <div class="tab-content">
          ...
          >
            <div>
              <div
                class="text-danger font-semibold mb-10 mt-5 flex space-x-2 float-right cursor-pointer"
                v-if="tabstatus"
                @click="updateOtherrequest"
              >
                <save-icon /> <span class="text-sm">Save</span>
              </div>
              <div
                class="text-danger font-semibold mb-10 mt-5 flex space-x-2 float-right cursor-pointer"
                v-else
                @click="tabstatus = true"
              >
                <edit-icon /> <span class="text-sm">Edit</span>
              </div>
            </div>
            <div>
              <div class="w-full mb-5">
                <p
                  class="text-sm relative top-14 w-full text-black uppercase font-bold"
                >
                  Preffered Consultation Medium
                </p>
              ...
              <div class="w-full">
                <p
                  class="text-sm relative w-full text-black uppercase font-bold"
                >
                  specimen collection
                </p>
                <div class="w-full flex space-x-4 mb-3">
              ...
              <div class="grid grid-cols-3 gap-4 mt-5">
                <div>
                  ...
                  <span v-else>
                    ...
                    >
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ basedOn }}
                    </div>
                  </span>
                ...
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.basicInfo.priority }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    <label class="block uppercase mb-1 text-xs font-bold"
                      >precondition code</label
                    >
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.request.preconditionCode }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.request.requestReference }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.request.reasonCode }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.basicInfo.intent }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.basicInfo.replaces }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.basicInfo.doNotPerform }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.basicInfo.activityDefinition }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.basicInfo.basedOn }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.requestInfo.encounter }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.request.preCondition }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    <label class="block uppercase mb-1 text-xs font-bold"
                      >supporting info</label
                    >
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.request.supportingInfo }}
                    </div>
                  </span>
                </div>
              </div>
                ...
                <div>
                  <span>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ selectedPractionerData.address }}
                    </div>
                  </span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.performer.performerType }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.performer.performer }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    <label class="block uppercase mb-1 text-xs font-bold"
                      >corniehealth id</label
                    >
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.userId }}
                    </div>
                  </span>
                </div>
                ...
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.performer.locationCode }}
                    </div>
                  </span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.request.note }}
                    </div>
                  </span>
                </div>
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.forms.linkForms }}
                    </div>
                  </span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span v-else>
                    ...
                    <div
                      class="bg-gray-100 text-sm text-gray-500 py-3 px-2 mt-3 rounded-md"
                    >
                      {{ otherrequestModel.request.patientInstructions }}
                    </div>
                  </span>
                </div>
              </div>
  ...
  get items() {
    const requests = this.otherrequests.map((request: any) => {
      ...
      return {
        ...
        period:
          request.request.occurencePeriod.start +
          "-" +
          request.request.occurencePeriod.end,
