                    ...
                    <Accordion title="Shift Details" v-model="showDetails" class="" :opened="true">
                        <div class="w-full px-4">
                            <div class="container-fluid py-6 flex justify-around">
                                <div class="w-4/12">
                                    <CornieInput v-model="shift.name" label="Name"  placeholder="--Enter--" />
                                </div>
                                <div class="w-4/12">
                                    <CornieInput label="Shift Description" v-model="shift.description"  placeholder="--Enter--" />
                                </div>
                                <div class="w-4/12">

                                    <CustomDropdown label="Healthcare Services" @itemSelected="healthServiceSelected" class="w-95" :items="items" :optionLabel="'name'" placeholder="--Enter--" />
                                </div>
                            </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="w-full flex mt-2">
                                    <div class="mr-6" v-for="(schedule, index) in schedules" :key="index">
                                        <label class="inline-flex items-center">
                                            <input type="radio" class="form-radio h-6 w-6" @change="selectSchedule(schedule.actual)" :checked="schedule.value" name="schedule">
                            ...
                            <div class="container-fluid my-3">
                                <div class="w-4/12">
                                    <CustomDropdown label="Time Zone" @itemSelected="zoneSelected" class="w-95" :items="timeZones" placeholder="--Enter--" />
                                </div>
                            </div>
                        </div>
                    </Accordion>
                    ...
                    <Accordion title="Shift Timing" v-model="showTiming" class="my-6">
                        <div class="w-full px-4">
                            <div class="container-fluid py-4">
                                ...
                                <div class="w-full flex mt-2">
                                    <div class="mr-6" v-for="(type, index) in shiftTypes" :key="index">
                                        <label class="inline-flex items-center">
                            ...
                            <div class="container-fluid py-3 flex">
                                ...
                                <div class="w-4/12">
                                    ...
                                    <label for="">
                                        ...
                                        <input type="time" v-model="shift.timeTo" class="w-full border rounded-lg p-2" id="appt" name="appt" required>
                                    </label>
                                </div>
                            </div>

                            <div class="container-fluid my-2">
                                <label class="my-2" for="">Select days this applies to</label><br>
                                <div class="my-3">
                                    <span class="mt-1 mr-6" v-for="(day, index) in days" :key="index">
                                        <span class="inline-flex flex items-center">
                                            <input type="checkbox" v-model="day.value" class="form-checkbox h-6 w-6">
                        ...
                        <div class="w-full px-4">
                            <div class="container-fluid py-4">
                                ...
                                <div class="w-full flex mt-2">
                                    <div class="mr-6" v-for="(type, index) in breakTypes" :key="index">
                                        <label class="inline-flex items-center">
                                            <input type="radio" class="form-radio h-6 w-6" @change="selectBreakType(type.actual)" v-model="type.value" name="break" >
                                            <span class="ml-2">{{ type.text }}</span>
                                        </label>
                                    </div>
                                </div>                                
                            ...
                            <div class="container-fluid py-3 flex">
                                <div class="w-4/12 mr-4">
                                    ...
                                    <label for="">
                                        <span class="uppercase font-bold text-xs">Time (To)</span>
                                        <input type="time" class="w-full border rounded-lg p-2" id="appt" name="appt" required>
                                    </label>
                                </div>
                                <div class="w-4/12">
...
export default class Shift extends Vue {
 ...
 async created() {
    ...
    console.log(this.healthcares, "HCs");
    if (this.$route.query.shiftId) {
        const shift = this.shifts.find((i: any) => i.id === this.$route.query.shiftId);
        ...
        if (shift) {
            ...
            if (this.shift.days) {
                this.days = this.days.map((i: any) => {
                    return {
                        ...i,
                        value: this.shift.days.indexOf(i.text.toLowerCase()) >= 0 ? true : false
                    }
                })
