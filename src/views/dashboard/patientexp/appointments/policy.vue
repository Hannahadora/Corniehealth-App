      ...
      >
        ...
        >
          ...
          >
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-end">
                <div class="mt-3 text-center sm:mt-0 sm:text-left">
                  ...
                  <p class="text-sm text-primary font-bold">Policy No: <span class="text-black font-medium">XXXXX</span></p> 
            ...
            <div class="px-4 py-3 sm:px-6 justify-center text-center w-full">
             <span class="text-sm  font-medium text-primary">View Policy Coverage</span>
            </div>
          </div>
        </div>
      </div>
