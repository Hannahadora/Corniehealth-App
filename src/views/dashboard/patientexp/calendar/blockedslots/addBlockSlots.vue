        ...
        <v-form ref="form">
            <div class="border-b-2 border-dashed border-gray-100">
                ...
                />
                 ...
                 <div class="w-full mt-4">
                    <span class="text-primary font-semibold text-sm ">Location</span>
                    <div class="w-full flex flex-wrap items-center py-5">
                        <div class="-mb-2">
                            <cornie-radio
                            :label="'Select'"
                  ...
                  <template v-slot:default>
                      <div class="grid grid-cols-2 gap-4">
                       ...
                       <div class="flex space-x-2 w-full mt-4 mb-7 pb-4 border-b-2 border-dashed border-gray-100">
                        ...
                        <div class="w-full flex space-x-7 mt-4 pb-4 border-b-2 border-dashed border-gray-100">
