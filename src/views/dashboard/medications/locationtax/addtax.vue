    ...
    >
      ...
      <form  @submit.prevent="submit">
          <div class="mb-32 pb-72">
                ...
                <div class="bg-blue-100 mt-4 text-black text-xs w-8/12 p-2 rounded-md">
                    Health-related products and services are mostly tax exempt, however we provide a tax module to ensure that you can comply when the product or service is taxable. <br><br>
                    Consequently, in the product and service catalogue, the tax is disabled by default, you will be required to enable it if the item being created is taxable.
                </div>
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-4">
                        <cornie-select
                            ...
                            <authority-select
                                label="Tax Authority"
                                class="required w-full"
                                :items="['Federal Inland Revenue Service','Lagos Internal Revenue Service']"
                                lefttext="FIRS"
                                placeholder="Select One"
                                />
                    </div>
                ...
                <div class="w-full justify-end">
                    <div class="flex justify-between mt-8">
                            <span class="flex flex-col">
                                <p class="text-primary font-bold w-full text-sm  float-left">Applicable Tax</p>
                            </span>
                            <span class="flex flex-col">
                                <plus-icon @click="showModal" class="float-right w-full cursor-pointer fill-current text-danger"/>
                            </span>
                    </div>
                    <div class="grid grid-cols-3 gap-4 w-full mt-4">
                        <tax-select
                                ...
                                placeholder="Select One"
                                />
                                <cornie-input disabled  label="Name Code"  placeholder="--Autoloaded--" class="w-full mb-4" />
                                <cornie-input  label="Tax Rate (%)"  placeholder="--Autoloaded-- but editable" class="w-full mb-4" />
