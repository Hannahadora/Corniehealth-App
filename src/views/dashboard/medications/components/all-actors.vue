              ...
              <div class="w-10/12 ml-2">
                <span class="flex justify-between">
                  ...
                  <span class="text-danger font-semibold"
                    ><a class="text-warning">Book Appointment</a></span
                  >
                </span>
              </div>
            </div>
...
export default class AllActors extends Vue {
  ...
  get persons() {
    ...
    return this.schedule.practitioners.filter(
      (i: any) =>
        (i.firstName && i.firstName.toLowerCase().includes(this.search)) ||
        (i.lastName && i.lastName.toLowerCase().includes(this.search))
    );
  }
}
</script>
