...
<div>
  ...
  <div class="h-full flex justify-center">
    <div class="w-full mx-5">
      <span class="w-full">
         <product-empty-state v-if="empty" />
        <product-existing-state v-else />
      </span>
    </div>
  </div>
</div>
...
import ProductEmptyState from "./emptyState.vue";
import ProductExistingState from "./existingState.vue";
