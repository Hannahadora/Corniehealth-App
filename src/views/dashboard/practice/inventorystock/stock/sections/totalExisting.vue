<template>
    <cornie-table v-model="items" :columns="headers">
        ...
        <template #actions>
            ...
            <div  class="flex items-center hover:bg-gray-100 p-3 cursor-pointer" @click="showStorage = true">
                <update-icon class="text-green-500 fill-current" />
                <span class="ml-3 text-xs">Storage Info</span>
            </div>
            <div class="flex items-center hover:bg-gray-100 p-3 cursor-pointer" @click="showAllocate = true">
        ...
        <storage-modal v-model="showStorage"/>
        <allocate-modal v-model="showAllocate"/>
...
import AllocateModal from "../components/AllocatebulkModal.vue";
