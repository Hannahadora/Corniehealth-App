<template>
      ...
      <cornie-card-text class="flex-grow scrollable">
        <v-form ref="form">
            <div class="border-b-2 w-full border-dashed pb-2 mb-7 border-gray-300">
                <span class="text-dark text-sm font-medium">Select Patient to check-in on a visit.</span>
                <div class="">
  ...
  <check-in-modal v-model="showCheckinModal" :patients="firstPatient"/>
</template>
...
export default class searchPatient extends Vue {
 ...
 @patients.State
  ...
  selected(value:any,id:any){
      this.patientIds.push({practitionerId: id, required: true });
