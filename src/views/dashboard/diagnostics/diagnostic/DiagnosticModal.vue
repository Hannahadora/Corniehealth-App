        ...
        <v-form ref="form">
              ...
              <template v-slot:default>
                <div class="w-full grid grid-cols-2 gap-5 mt-5 pb-5">
                  <cornie-select class="required" :rules="required" :items="[
                    ...
                    'entered-in-error',
                    'ordered',
                  ]" label="Status" placeholder="--Select--" v-model="status">
                  </cornie-select>
                  ...
                  <cornie-select class="required" :rules="required" :items="['Routine', 'Urgent', 'ASAP', 'STAT']"
          ...
          <div class="border-b-2 pb-5 border-dashed border-gray-200">
            <accordion-component title="Request Info" :opened="true">
              <template v-slot:default>
                <div class="w-full grid grid-cols-2 gap-5 mt-5 pb-5">
                  <cornie-input :rules="required" class="grow w-full" :placeholder="'Autoloaded'"
                    :label="'Request code'" v-model="reasonCode" />
                  <cornie-select class="required" :rules="required" :items="['Routine', 'Urgent', 'ASAP', 'STAT']"
                    label="Order Detail" v-model="orderDetail" placeholder="--Select--">
                    <template #labelicon>
                      <span class="text-xs text-gray-500">(Optional)</span>
                  ...
                  <div class="w-full -mt-1">
                    ...
                    <div class="flex space-x-2 w-full">
                      ...
                      <cornie-select :items="['Day']" placeholder="Ratio" class="w-32 mt-0.5 flex-none"
                        :setPrimary="true" v-model="quantityUnit" />
                    </div>
                  </div>
                  <cornie-input :rules="required" placeholder="Enter" class="grow w-full" :label="'Request Description'"
                    v-model="requestDescription" />
                  <cornie-input :rules="required" placeholder="Enter" class="grow w-full" :label="'Body Site'"
                    v-model="bodySite" />
                </div>
              </template>
            </accordion-component>
          ...
          <div class="border-b-2 pb-5 border-dashed border-gray-200">
            <accordion-component title="Patient Info" :opened="true">
              <template v-slot:default>
                <div class="w-full grid grid-cols-2 gap-5 mt-5 pb-5">
                  <cornie-select class="" :label="'Patient'" v-model="patientId" :items="allRequester"
                    :innerlabel="'Self pay'" :labelText="true">
                  </cornie-select>
                  <!-- <cornie-select
                            :rules="required"
                            placeholder="select"
                            ...
                            v-model="encounterId"
                        /> -->
                  <encounter-select :rules="required" placeholder="select" class="w-full" :label="'Encounter'"
                    :patientId="patientId" v-model="encounterId" />
                  <div class="w-full -mt-1">
                    <span class="text-sm font-semibold mb-3">Quantity</span>
                    <div class="flex space-x-2 w-full">
                      <cornie-input :rules="required" placeholder="--Enter--" class="grow w-full" :setfull="true"
                      ...
                      <cornie-select :items="['Day']" placeholder="Ratio" class="w-32 mt-0.5 flex-none"
                        :setPrimary="true" v-model="occurenceUnit" />
                    </div>
                  </div>
                  <cornie-select class="required" :rules="required" :items="allPerformerDispenser" label="Performer"
                    v-model="performerId" placeholder="Select">
                  </cornie-select>
                  <cornie-select class="required" :rules="required" :items="allLocations" label="Location"
                    v-model="locationId" placeholder="Select">
                  </cornie-select>
                </div>
              </template>
            </accordion-component>
          ...
          <accordion-component title="Optional Section"
            ...
            <div class="border-b-2 border-gray-200 mt-5 border-dashed pb-3">
              <div class="w-full grid grid-cols-2 gap-5 mt-2 pb-5">
                <cornie-select class="required w-full" :rules="required" :items="['reason code']" label="Replaces"
                  placeholder="--Select--" v-model="replaces">
                </cornie-select>
                <cornie-select :rules="required" :items="['reason reference']" label="As Needed"
                  placeholder="--Select--" class="w-full" v-model="asNeeded">
                </cornie-select>
                <cornie-input :rules="required" label="As Needed Code" placeholder="Autoloaded" class="w-full"
                  v-model="asNeededCode">
                </cornie-input>
                <cornie-input :rules="required" label="Reason Code" placeholder="Autoloaded" v-model="reasonCode">
                </cornie-input>
                <cornie-select :rules="required" :items="['reason reference']" label="Reason Reference"
                ...
                <cornie-input :rules="required" label="Patient Instruction" placeholder="Autoloaded" class="w-full"
                  v-model="patientInstructions">
                </cornie-input>
                <div class="mb-5">
                  <span class="text-sm font-semibold mb-1">Link Forms</span>
                  <Multiselect v-model="forms" mode="tags" :hide-selected="false" id="field-id" :options="allForms"
                    value-prop="code" trackBy="code" label="display" placeholder="--Select--" class="w-full">
