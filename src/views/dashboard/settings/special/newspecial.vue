      ...
      <cornie-card-text class="flex-grow scrollable">
        <v-form ref="form">
         ...
         <cornie-select
            ...
            @selected="addArray"
              v-model="special"
              :items="['The fat pig', 'The fat house']"
              class="w-full"
            />
         
         <div class="grid grid-cols-2 gap-4 mt-3 border-b-2 border-dashed border-gray-300 pb-5">
            <div
              class="flex space-x-4 bg-primary rounded-full text-white py-2 px-0 w-auto text-center justify-center"
