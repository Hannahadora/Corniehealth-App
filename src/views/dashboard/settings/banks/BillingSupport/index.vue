<template>
  <div class="w-full mt-8">
    <span class="text-lg font-bold">Billing Support</span>
    <span class="text-sm text-gray-200">Create a medium for patient to contact your organization on billing related issues</span>
...
export default class BillingSupport extends Vue {
