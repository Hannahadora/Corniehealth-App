   ...
   <div class="">
    ...
    <div class="tab-content">
            ...
            <div>
                ...
                <cornie-table :columns="rawHeaders" v-model="items">
                    <template #actions="{ item }">
                      <div class="flex items-center hover:bg-gray-100 p-3 cursor-pointer" @click="$router.push('/dashboard/settings/practise-management/transaction-history')">
        ...
        <div class="tab-pane" v-if="selected == 2"  :class="{'active' :  selected === 2  }" id="Direct Debit">
          ...
          <p class="mt-4 text-sm">
            It facilitates third-party payments from your regular profiled bank accounts to third-party beneficiaries (for Example, salary payments to employees, supplier payments, etc.)
          </p>
          <p class="mt-4 text-sm">
            To activate your account on Paystack, you must profile on NAPS. Once you set up, you can securely initiate and conclude third-party payments directly from Cloudenly.
          </p>
          <div class="p-2 mt-5 rounded text-sm bg-gray-100 cursor-pointer text-danger text-center font-semibold">
              Set-up Process
          </div>
          <div class="grid grid-cols-3 gap-4 w-full">
            <div class="mt-7 shadow-md">
                ...
                <p class="text-xs mb-5  leading-5">
                    Download the following documents templates, adapt, execute and submit to the relevant parties
                </p>
                <p class="text-xs mb-5  leading-5">
                ...
                <div class="flex space-x-4">
                      <span>
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.434 5.83431L8.79971 8.46863V0H7.19971V8.46863L4.5654 5.83431L3.43403 6.96568L7.99971 11.5314L12.5654 6.96568L11.434 5.83431ZM16 14.4001V11.2001H14.4V14.4001H1.6V11.2001H0V14.4001C0 15.2837 0.716344 16.0001 1.6 16.0001H14.4C15.2837 16.0001 16 15.2837 16 14.4001Z" fill="#F15846"/>
                        </svg>
            ...
            <div class="mt-7 shadow-md">
                ...
                <div class="p-5 mt-5 justify-center">
                <p class="text-xs mb-5  leading-5">
                    You will be notified by Paystack, once your account is set up. You will be required to activate your account by  completing a test transaction of N100 below.
                </p>
                <div class="flex space-x-2">
                      <span>
                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.66699 0C14.617 0 18.667 4.05 18.667 9C18.667 13.95 14.617 18 9.66699 18C4.71699 18 0.666992 13.95 0.666992 9C0.666992 4.05 4.71699 0 9.66699 0ZM9.66699 1.8C7.95699 1.8 6.42699 2.34 5.25699 3.33L15.337 13.41C16.237 12.15 16.867 10.62 16.867 9C16.867 5.04 13.627 1.8 9.66699 1.8ZM14.077 14.67L3.99699 4.59C3.00699 5.76 2.46699 7.29 2.46699 9C2.46699 12.96 5.70699 16.2 9.66699 16.2C11.377 16.2 12.907 15.66 14.077 14.67Z" fill="#F15846"/>
                        </svg>
                      </span>
                      <span class="text-danger text-xs font-semibold">
                       Activate Account
            ...
            <div class="mt-7 shadow-md">
                ...
                <div class="p-5 mt-5 justify-center">
                    <p class="text-xs mb-5 leading-5">
                        You are all set! You can now start making payments directly from Cloudenly - Process your payroll and supplier payments while enforcing strict control.
                    </p>
                </div>
            </div>
          </div>
