             ...
             <template  v-slot:default>
              <div class="w-full">
                ...
                <div class="w-full grid grid-cols-3 gap-4">
                  <cornie-input :modelValue="identifier" label="Identifier" disabled />
                  <cornie-select
                    :rules="required"
                    ...
                    placeholder="--Select--"
                  />
                  <cornie-input v-model="type" label="Type"  placeholder="--Enter--"/>
                  <cornie-input
                    :rules="required"
                    v-model="name"
                  ...
                  <phone-input
                    ...
                    label="Phone Number"
                     placeholder="--Enter--"
                  />
                  <cornie-input :rules="emailRule" v-model="email"  placeholder="--Enter--" label="Email" />
                  <cornie-input
                    :rules="required"
                    v-model="address"
                    label="Address"
           ...
           <accordion-component title="Qualification" :opened="true">
             <template  v-slot:default>
              <div class="w-full grid grid-cols-3 gap-4 mt-3">
                <cornie-input disabled label="Identifier" :modelValue="identifier" />
                <cornie-select
                  ...
                  label="Code"
                   ...
                   class="w-full"
                />
                <period-picker label="Period" class="-mt-1.5" v-model="period"  placeholder="--Select--"  />
                <cornie-input v-model="qualificationIssuer" label="Issuer" class="w-full"  placeholder="--Enter--" />
                <cornie-select
                  ...
                  label="Communication"
                   ...
                   class="w-full"
                />
                <cornie-input v-model="licenseNumber" label="License Number"  placeholder="--Enter--" />
              </div>
             </template>
             <template v-slot:misc>
                 <info-icon class="fill-current text-primary"/>
