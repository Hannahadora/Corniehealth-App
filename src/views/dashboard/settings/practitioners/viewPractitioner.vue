...
<script lang="ts">
  ...
  export default class AddPractitioner extends Vue {
      ...
      switch (this.currentTab) {
        ...
        case 2:
          return {
            ...
            jobDescription: this.jobMapper(this.jobDesignation),
            consultationRate: this.hourlyRate,
            yearsOfPractice: {
    ...
    async setPractitioner() {
      console.log("practitioner id", this.id);
      const practitioner = await this.getPractitionerById(this.id);

      console.log("view details", practitioner);
      ...
      //@ts-ignore
      this.hourlyRate = practitioner.hourlyRate;
      //@ts-ignore
      this.employmentType = practitioner.employmentType;
      //@ts-ignore
      this.licenses = practitioner.boardLicenses;
      console.log("employmentType", this.jobDesignation);
    }
