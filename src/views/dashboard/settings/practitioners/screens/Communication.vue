<template>
  <screen-header :properties="properties"> Communication </screen-header>
  <div v-if="properties">
    <div class="grid grid-cols-4 gap-1">
      <div class="flex flex-col">
        <h1 class="text-gray-400 mb-1 text-sm">Communication</h1>
        <h1 class="text-sm">{{ properties.communication }}</h1>
      </div>
    </div>
  </div>
</template>
