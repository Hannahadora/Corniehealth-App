<template>
  <div class="bg-white rounded  p-5 mt-5">
    <input
      ...
      @input="display($event)"
    />
    <form class="mt-20 w-full" @submit.prevent="submit" autocomplete="off">
      ...
      <div class="w-full">
          <accordion-component title="Identifier" :opened="true">
              <template v-slot:default>
                  <div class="w-full grid grid-cols-3 gap-4 mt-5">
                      ...
                      <cornie-select label="Status" class="required w-full" :required="true" placeholder="--Select"/>
                        <div class="mb-2">
         ...
         <accordion-component title="Subject" :opened="true">
              <template v-slot:default>
                  <div class="w-full grid grid-cols-3 gap-4 mt-5">
                      <cornie-select label="Subject Type" class="required w-full" :required="true" placeholder="--Select"/>
                      <cornie-input label="Purpose" class="required w-full" :required="true" placeholder="--Enter--"/>
                       ...
                       <cornie-select label="Code" class="required w-full"  placeholder="--Select"/>
                  </div>
              </template>
          </accordion-component>
      </div>
                                                ...
                                                <template v-slot:default>
                                                    ...
                                                    <div class="mt-4">
                                                        <span class="flex item-center mb-1">
                                                            ...
                                                            <input
                                                                type="checkbox"
                                                                class="form-checkbox h-2 w-2"
                                                            />
                                                            </label>
                                                            <span contenteditable="true" class="text-sm mt-4 ml-3 w-full">Option 1
                                                            </span>
                                                        </span>
                                                        <span class="flex item-center mb-1">
                                                            <label class="inline-flex items-center mt-3">
                                                            ...
                                                            <span contenteditable="true" class="text-sm mt-7 ml-3 w-full">Option 2

                                                            <div class="border-b-2 border-green-400 w-full pt-3">
                                                ...
                                                <template v-slot:default>
                                                    ...
                                                    <div class="mt-4">
                                                        <!-- <span class="flex item-center mb-1">
                                                            ...
                                                            <span contenteditable="true" class="text-sm mt-7 ml-3 w-full">Option 1
                                                        ...
                                                        <span class="flex item-center mb-2">
                                                            <cornie-radio class="text-black" />
                                                            <span contenteditable="true"  class="text-sm mt-4 w-full">I don’t smoke
                                                            </span>
                                                        </span>
                                                         <span class="flex item-center mb-2">
                                                            <cornie-radio class="text-black" />
                                                            <span contenteditable="true"  class="text-sm mt-7 w-full">Option 1
                                                            <div class="border-b-2 border-green-400 w-full pt-3">
                                                                <cancel-icon class="float-right -mt-3 cursor-pointer"/>
                                                            </div>
                                                            </span>
