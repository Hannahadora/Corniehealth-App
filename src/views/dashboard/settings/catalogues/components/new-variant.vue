    ...
    <div class="container-fluid px-3">
        <div class="w-full">
            ...
            <div class="w-full my-4">
                <cornie-select :label="'Form'" v-model="data.form" style="width:100%" :items="['Option 1']" />
            </div>

            <div class="w-full my-4">
                <cornie-select :label="'Pack'" v-model="data.pack" style="width:100%" :items="['Option 1']" />
            </div>

            <div class="w-full my-4">
                <cornie-input :label="'Pack Quantity'" v-model="data.packQuantity" style="width:100%" />
            </div>

            <div class="w-full my-4">
                <cornie-select :label="'Strength'" v-model="data.strength" style="width:100%" :items="['Option 1']" />
            </div>

            <div class="w-full my-4">
                <a class="flex add-xteristic"><span class="mr-2"><add-icon /></span> <span>Add New Characteristics</span></a>
            </div>
        </div>
