        ...
        >
          ...
          >
            ...
            <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              <cornie-btn
                @click="approved"
                class="w-full inline-flex justify-center rounded border border-transparent shadow-sm px-4 py-1 bg-danger text-base font-medium text-white focus:outline-none sm:ml-3 sm:w-auto sm:text-sm"
                type="submit"
              >
                {{ yes }}
              </cornie-btn>
              <cornie-btn
                type="button"
                @click="cancelled"
                class="mt-3 w-full inline-flex justify-center rounded border border-white-300 shadow-sm px-4 py-1 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
              >
                {{ no }}
              </cornie-btn>
            </div>
