      ...
      <cornie-card-text class="flex-grow scrollable">
        <ul class="w-full p-3">            
              <li class="w-full mb-5">
                    <router-link to="/" class="flex space-x-4 items-center text-black font-medium">
                        <home-icon/>
                        <span>Home</span>
                    </router-link>
              </li>
             ...
             <li class="w-full mb-7">
                <div class="flex w-full justify-between">
                    <div>
                        <span class="font-bold text-black cursor-pointer" @click="showOthers = !showOthers">Others</span>
                    </div>
                    <div>
                        <chevron-down-icon
                            v-if="showOthers"
