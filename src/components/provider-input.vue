  ...
  <div>
    ...
    >
      <div class="flex items-center w-full">
        ...
        <input
          style="width: 50%"
          class="appearance-none border bg-primary px-3 py-3 ml-1 rounded-md placeholder-white focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
          disabled
