   ...
   <div class="grid  grid-cols-1 grid-flow-col gap-4">
        <div>
            ...
            <div  class="flex space-x-4 w-full justify-between px-3">
                <div class="float-left px-3 pl-7 pr-7 py-3 bg-primary border-primary font-semibold text-white uppercase sectionclass text-xs">
                   section {{num1}} of {{num2}}
                </div>
                <div class="float-right flex space-x-4">
                    <chevron-down-icon class="w-full mt-3 cursor-pointer stroke-current text-primary"   @click="expand = false" v-if="expand"/>
                     <chevron-right-icon class="w-full mt-3 cursor-pointer stroke-current text-primary"   v-else @click="expand = true"/>
                   <div>
