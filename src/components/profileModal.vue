  ...
  >
    <cornie-card height="100%" class="flex flex-col animated fadeInUp">
      ...
      <cornie-card-text class="flex-grow scrollable">
        <ul class="w-full">
          <li
            class="flex w-full justify-between mb-3 pb-5 border-b-2 border-gray-100"
          >
            <div class="flex space-x-3 items-center">
              ...
              <div>
                <p class="text-lg text-blue-600 mb-0 font-extrabold capitalize">
                  {{ name }}
                </p>
                <p class="text-sm text-black mb-1">MRN - {{ mrn }}</p>
                <div>
                  <span
                    class="bg-green-100 text-sm text-green-500 py-1 rounded-md px-4"
          ...
          <li class="w-full mb-7">
            <div>
              <span class="font-medium text-black cursor-pointer"
                >Feedback</span
              >
            </div>
          </li>
          ...
          <li class="w-full mb-0 border-b border-gray-200 pb-5">
            <div>
              <span
                class="font-medium text-danger cursor-pointer"
                @click="logout"
                >Sign Out</span
              >
            </div>
      ...
      <cornie-card>
        <cornie-card-text class="w-full">
          <div class="w-full mb-4 flex justify-center">
            <cornie-btn
              class="text-white bg-danger px-10 py-1 text-xs font-semibold rounded-xl"
          ...
          <div class="w-full mb-4 flex justify-center">
            <cornie-btn
              class="border-primary border-2 px-2 py-0.5 text-xs font-semibold rounded-xl text-primary"
              @click="
                $router.push(
