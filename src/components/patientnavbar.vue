<template>
  <nav class="hidden md:block p-5 min-w-full items-center w-full  h-36">
    <div class="flex float-right space-x-4 justify-end items-center border-b-2 pb-3 border-gray-100 w-full">
        ...
        <div>
            <cornie-btn class="text-white bg-danger px-6 font-semibold rounded-xl">Download App</cornie-btn>
        </div>
    </div>
  ...
  <nav class="flex md:hidden min-w-full items-center w-full border-b-2 h-14">
    <div class="flex space-x-4 w-full justify-start items-center pt-3 pb-3">
        <menu-icon class="cursor-pointer" @click="showMobileMenu = true"/>
         <div
            class="flex flex-row justify-between pb-1 items-center"
        >
            <img src="@/assets/img/logo.svg" class="h-5 w-5"/>
            <h2 class="text-primary text-xs font-semibold ml-1">
            CornieHealth
            </h2>
        </div>
