       ...
       <span class="flex space-x-2">
        ...
        <span class="flex space-x-2">
           <svg width="24" height="24" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.5 4.25H9.75V2C9.75 1.175 9.075 0.5 8.25 0.5H6.75C5.925 0.5 5.25 1.175 5.25 2V4.25H1.5C0.675 4.25 0 4.925 0 5.75V14C0 14.825 0.675 15.5 1.5 15.5H13.5C14.325 15.5 15 14.825 15 14V5.75C15 4.925 14.325 4.25 13.5 4.25ZM5.25 8C5.8725 8 6.375 8.5025 6.375 9.125C6.375 9.7475 5.8725 10.25 5.25 10.25C4.6275 10.25 4.125 9.7475 4.125 9.125C4.125 8.5025 4.6275 8 5.25 8ZM7.5 12.5H3V11.9375C3 11.1875 4.5 10.8125 5.25 10.8125C6 10.8125 7.5 11.1875 7.5 11.9375V12.5ZM8.25 5.75H6.75V2H8.25V5.75ZM12 11.375H9V10.25H12V11.375ZM12 9.125H9V8H12V9.125Z" fill="#080056"/>
                </svg>
        ...
        <span class="flex space-x-2 mt-2">
         <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0.5 4C0.5 1.79086 2.29086 0 4.5 0H14.5C16.7091 0 18.5 1.79086 18.5 4V14C18.5 16.2091 16.7091 18 14.5 18H4.5C2.29086 18 0.5 16.2091 0.5 14V4Z" fill="white"/>
            <path d="M5.465 8.0925C6.545 10.215 8.285 11.9475 10.4075 13.035L12.0575 11.385C12.26 11.1825 12.56 11.115 12.8225 11.205C13.6625 11.4825 14.57 11.6325 15.5 11.6325C15.9125 11.6325 16.25 11.97 16.25 12.3825V15C16.25 15.4125 15.9125 15.75 15.5 15.75C8.4575 15.75 2.75 10.0425 2.75 3C2.75 2.5875 3.0875 2.25 3.5 2.25H6.125C6.5375 2.25 6.875 2.5875 6.875 3C6.875 3.9375 7.025 4.8375 7.3025 5.6775C7.385 5.94 7.325 6.2325 7.115 6.4425L5.465 8.0925Z" fill="#080056"/>
            </svg>

            <span class="text-gray-500 font-light text-sm">
                {{PatientName.contactInfo[0].phone.dialCode +' '+ PatientName.contactInfo[0].phone.number}}
            </span>
       </span>
        <span class="flex space-x-2 mt-2">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 4C0 1.79086 1.79086 0 4 0H14C16.2091 0 18 1.79086 18 4V14C18 16.2091 16.2091 18 14 18H4C1.79086 18 0 16.2091 0 14V4Z" fill="white"/>
        <path d="M15 3H3C2.175 3 1.5075 3.675 1.5075 4.5L1.5 13.5C1.5 14.325 2.175 15 3 15H15C15.825 15 16.5 14.325 16.5 13.5V4.5C16.5 3.675 15.825 3 15 3ZM15 6L9 9.75L3 6V4.5L9 8.25L15 4.5V6Z" fill="#080056"/>
        </svg>
...
get PractitionerInfo() {
        ...
        const pt = this.practitioners.find((practitioner) => practitioner.id === id );
        return {
            ...practitioner
        }
    }
